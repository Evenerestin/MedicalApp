...
const meta: Meta<typeof Button> = {
  title: "Atoms/Buttons/Button/Filled",
  component: Button,
...
export const FullWidth: StoryObj<typeof Button> = {
  args: { variant: "filled", fullWidth: true },
};
...
export const LeftIcon: StoryObj<typeof Button> = {
  args: { variant: "filled", size: "md" },
  render: (args) => (
    <Button {...args} leftSection={<IconBell size={16} color="#fff" />} />
  ),
};
...
export const RightIcon: StoryObj<typeof Button> = {
  ...
  render: (args) => (
    <Button
      {...args}
      rightSection={<IconChevronRight size={16} color="#fff" />}
    />
  ),
};
